  ...
  render() {
    return (
      <div style={styles.main}>
        ...
        <p>
          See these sample <a style={styles.link} href='#' onClick={this.showApp.bind(this)}>stories</a> for a component called <code style={styles.code}>InputText</code>.
        </p>
        <p>
          ...
          <br />
          (Try editing the <code style={styles.code}>InputText</code> component
          located at <code style={styles.code}>src/stories/form/input-text.js</code>.)
        </p>
        <p>
